...
if [ "$1" = "train_tiny" ]; then
  	...
  	python run.py train --embedding-type='fasttext' --max-epoch=50 --single-fold --prep-verbs=-1 --prep-emoticon-emojis=-1 --prep-abbreviations=-1 --prep-elongations=-1 --prep-lowering=0 --dont-save-prep --dont-load-prep
